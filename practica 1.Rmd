...
#disturbio agregado en el año 101 con efecto de 30 años
...
detrend.series(Agregado, method = "Spline", nyrs = 40) # en ese caso se ajusta una curva mas flexible  llamada Qubic spline  con 40 años de flexibilidad.
...
det_sp <- detrend.series(Agregado, method = "Spline", nyrs = 40)
...
```
### Conclucion, El spline de 50 años logra minimizar el efecto de la edad y de ese evento de disturbio.

#### Otro ejemplo del modelo agregado es  cuando observamos como el CO2 atmosférico  o el dióxido de carbono,  varia mensualmente  a lo largo de los últimos 4 años   
