...
setwd('/Users/paul/Desktop/Dendro Guatemala/')
...
wa084 <- read.rwl('MINAS-RW-GUATEMALA.rwl.txt')
# plot segments
spag.plot(wa084)
wa084.stats <- rwl.stats(wa084)
...
# Let's detrend all the series in wa084 with a spline:
wa084.rwi <- detrend(wa084, method="Spline")
...
wa084.ids <- read.ids(wa084.rwi, stc = 'auto')
wa084.rwi.stats <- rwi.stats(wa084.rwi,ids=wa084.ids)
